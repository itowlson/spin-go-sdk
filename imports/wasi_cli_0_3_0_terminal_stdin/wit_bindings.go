...
package wasi_cli_0_3_0_terminal_stdin

import (
	"github.com/spinframework/spin-go-sdk/v3/imports/wasi_cli_0_3_0_terminal_input"
...
type TerminalInput = wasi_cli_0_3_0_terminal_input.TerminalInput

//go:wasmimport wasi:cli/terminal-stdin@0.3.0 get-terminal-stdin
func wasm_import_get_terminal_stdin(arg0 uintptr)

func GetTerminalStdin() witTypes.Option[*wasi_cli_0_3_0_terminal_input.TerminalInput] {
	pinner := &runtime.Pinner{}
	defer pinner.Unpin()

	returnArea := uintptr(witRuntime.Allocate(pinner, 8, 4))
	wasm_import_get_terminal_stdin(returnArea)
	var option witTypes.Option[*wasi_cli_0_3_0_terminal_input.TerminalInput]
	switch uint8(*(*uint32)(unsafe.Add(unsafe.Pointer(returnArea), 0))) {
	case 0:

		option = witTypes.None[*wasi_cli_0_3_0_terminal_input.TerminalInput]()
	case 1:

		option = witTypes.Some[*wasi_cli_0_3_0_terminal_input.TerminalInput](wasi_cli_0_3_0_terminal_input.TerminalInputFromOwnHandle(int32(uintptr(*(*int32)(unsafe.Add(unsafe.Pointer(returnArea), 4))))))
	default:
		panic("unreachable")
	}
	result := option
