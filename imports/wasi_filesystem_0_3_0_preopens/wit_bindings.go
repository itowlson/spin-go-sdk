...
package wasi_filesystem_0_3_0_preopens

import (
	"github.com/spinframework/spin-go-sdk/v3/imports/wasi_filesystem_0_3_0_types"
...
type Descriptor = wasi_filesystem_0_3_0_types.Descriptor

//go:wasmimport wasi:filesystem/preopens@0.3.0 get-directories
func wasm_import_get_directories(arg0 uintptr)

func GetDirectories() []witTypes.Tuple2[*wasi_filesystem_0_3_0_types.Descriptor, string] {
	pinner := &runtime.Pinner{}
	defer pinner.Unpin()

	returnArea := uintptr(witRuntime.Allocate(pinner, (2 * 4), 4))
	wasm_import_get_directories(returnArea)
	result := make([]witTypes.Tuple2[*wasi_filesystem_0_3_0_types.Descriptor, string], 0, *(*uint32)(unsafe.Add(unsafe.Pointer(returnArea), 4)))
	for index := 0; index < int(*(*uint32)(unsafe.Add(unsafe.Pointer(returnArea), 4))); index++ {
		...
		result = append(result, witTypes.Tuple2[*wasi_filesystem_0_3_0_types.Descriptor, string]{wasi_filesystem_0_3_0_types.DescriptorFromOwnHandle(int32(uintptr(*(*int32)(unsafe.Add(unsafe.Pointer(base), 0))))), value})
	}
