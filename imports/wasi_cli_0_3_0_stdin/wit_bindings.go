...
import (
	"github.com/spinframework/spin-go-sdk/v3/imports/wasi_cli_0_3_0_types"
...
func ReadViaStream() (*witTypes.StreamReader[uint8], *witTypes.FutureReader[witTypes.Result[witTypes.Unit, wasi_cli_0_3_0_types.ErrorCode]]) {
	...
	result := witTypes.Tuple2[*witTypes.StreamReader[uint8], *witTypes.FutureReader[witTypes.Result[witTypes.Unit, wasi_cli_0_3_0_types.ErrorCode]]]{LiftStreamU8(*(*int32)(unsafe.Add(unsafe.Pointer(returnArea), 0))), LiftFutureResultUnitWasiCli030TypesErrorCode(*(*int32)(unsafe.Add(unsafe.Pointer(returnArea), 4)))}
	tuple := result
